...
var Main = /** @class */ (function () {
    ...
    Main.prototype.addRadial = function () {
        // TODO random
        this.tensorField.addRadial(new vector_1.default(0, 0), 300, 20);
    };
    Main.prototype.addGrid = function () {
        // TODO random
        this.tensorField.addGrid(new vector_1.default(0, 0), 800, 20, Math.PI / 4);
    };
    ////////////////////////////////
...
var StreamlineGenerator = /** @class */ (function () {
     ...
     */
    StreamlineGenerator.prototype.streamlineIntegrationStep = function (params, major, extraSamples) {
        if (extraSamples === void 0) { extraSamples = []; }
        if (params.valid) {
    ...
    function DomainController() {
        ...
        window.addEventListener('wheel', function (e) {
            ...
            if (delta > 0) {
                ...
                _this.zoom = _this.zoom / _this.ZOOM_SPEED;
            }
        });
    }
