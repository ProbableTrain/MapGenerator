...
var tensor_field_1 = require("./ts/tensor_field");
var vector_1 = require("./ts/vector");
var canvas_wrapper_1 = require("./ts/canvas_wrapper");
var constants_1 = require("./ts/constants");
var drag_controller_1 = require("./ts/drag_controller");
var domain_controller_1 = require("./ts/domain_controller");
var integrator_1 = require("./ts/integrator");
var streamlines_1 = require("./ts/streamlines");
var size = 800;
var dc = domain_controller_1.default.getInstance(vector_1.default.fromScalar(size));
var c = document.getElementById(constants_1.default.CANVAS_ID);
var canvas = new canvas_wrapper_1.default(c, size, size);
var gui = new dat.GUI();
var tensorFolder = gui.addFolder('Tensor Field');
var field = new tensor_field_1.default(tensorFolder, new drag_controller_1.default(gui));
...
gui.add(dc, 'zoom', 0, 5);
var integrator = new integrator_1.RK4Integrator(field, params);
var s = new streamlines_1.default(integrator, params);
var streamlines = [];
function setStreamline() {
    s = new streamlines_1.default(integrator, params);
...
function draw() {
    ...
    if (s.allStreamlinesSimple.length > 0) {
        ...
        s.allStreamlinesSimple.forEach(function (s) {
...
},{"./ts/canvas_wrapper":8,"./ts/constants":9,"./ts/domain_controller":10,"./ts/drag_controller":11,"./ts/integrator":13,"./ts/streamlines":14,"./ts/tensor_field":16,"./ts/vector":17,"dat.gui":1}],6:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./tensor":15}],8:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var log = require("loglevel");
...
},{"loglevel":3}],9:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var Constants = /** @class */ (function () {
    function Constants() {
    }
    Constants.CANVAS_ID = 'map-canvas';
    return Constants;
}());
...
},{"./Vector":6}],11:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var DragController = /** @class */ (function () {
    function DragController(gui) {
        ...
        interactjs_1.default("#" + constants_1.default.CANVAS_ID).draggable({
    ...
    DragController.prototype.updateGui = function (gui) {
...
},{"./Vector":6,"./constants":9,"./domain_controller":10,"interactjs":2}],12:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var log = require("loglevel");
var vector_1 = require("./vector");
...
},{"./vector":17,"loglevel":3}],13:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
...
var domain_controller_1 = require("./domain_controller");
var Streamlines = /** @class */ (function () {
    /**
     * Uses world-space coordinates
     */
    function Streamlines(integrator, params) {
        this.integrator = integrator;
        this.params = params;
        this.domainController = domain_controller_1.default.getInstance();
        this.worldDimensions = this.domainController.worldDimensions.clone();
        this.origin = this.domainController.origin.clone();
    ...
    Object.defineProperty(Streamlines.prototype, "allStreamlines", {
        get: function () {
            // Combine
    ...
    Streamlines.prototype.update = function () {
     ...
     */
    Streamlines.prototype.createAllStreamlinesDynamic = function () {
        this.streamlinesDone = false;
    };
    /**
     * All at once - will freeze if dsep small
     */
    Streamlines.prototype.createAllStreamlines = function () {
        var major = true;
     ...
     */
    Streamlines.prototype.createStreamline = function (major) {
        ...
        if (this.validStreamline(streamline)) {
            ...
            this.allStreamlinesSimple.push(simplify(streamline, this.params.simplifyTolerance).map(function (point) { return new vector_1.default(point.x, point.y); }));
            // Add candidate seeds
    ...
    Streamlines.prototype.validStreamline = function (s) {
        return s.length > 5;
    };
    Streamlines.prototype.setParamsSq = function () {
        this.paramsSq = Object.assign({}, this.params);
        for (var p in this.paramsSq) {
            this.paramsSq[p] *= this.paramsSq[p];
        }
    };
    Streamlines.prototype.samplePoint = function () {
     ...
     */
    Streamlines.prototype.getSeed = function (major) {
    ...
    Streamlines.prototype.candidateSeeds = function (major) {
        return major ? this.candidateSeedsMajor : this.candidateSeedsMinor;
    };
    Streamlines.prototype.streamlines = function (major) {
        return major ? this.streamlinesMajor : this.streamlinesMinor;
    };
    Streamlines.prototype.grid = function (major) {
        return major ? this.majorGrid : this.minorGrid;
    };
    Streamlines.prototype.pointInBounds = function (v) {
     ...
     */
    Streamlines.prototype.streamlineIntegrationStep = function (params, major) {
        if (params.valid) {
     ...
     */
    Streamlines.prototype.integrateStreamline = function (seed, major) {
        var count = 0;
...
exports.default = Streamlines;

},{"./domain_controller":10,"./grid_storage":12,"./vector":17,"loglevel":3,"simplify-js":4}],15:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var vector_1 = require("./vector");
...
},{"./vector":17}],16:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var tensor_1 = require("./tensor");
var basis_field_1 = require("./basis_field");
var TensorField = /** @class */ (function () {
    function TensorField(guiFolder, dragController) {
    ...
    TensorField.prototype.addField = function (field) {
        ...
        var removeFieldObj = { remove: function () { return _this.removeField.bind(_this)(field, folder, deregisterDrag); } };
        // Give dat gui removeField button
        folder.add(removeFieldObj, 'remove');
        field.setGui(folder);
        this.basisFields.push(field);
    };
    TensorField.prototype.removeField = function (field, folder, deregisterDrag) {
...
},{"./basis_field":7,"./tensor":15}],17:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var log = require("loglevel");
var Vector = /** @class */ (function () {
...
},{"loglevel":3}]},{},[5,7,8,9,10,11,12,13,14,16,15,17])
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
