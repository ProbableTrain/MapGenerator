...
},{"./ts/canvas_wrapper":7,"./ts/constants":8,"./ts/domain_controller":9,"./ts/drag_controller":10,"./ts/integrator":12,"./ts/streamlines":13,"./ts/tensor_field":15,"./ts/vector":16,"dat.gui":1}],5:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"loglevel":3}],6:[function(require,module,exports){
"use strict";
...
},{"./tensor":14}],7:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var log = require("loglevel");
...
},{"./Vector":5}],10:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./Vector":5,"./constants":8,"./domain_controller":9,"interactjs":2}],11:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var log = require("loglevel");
var vector_1 = require("./vector");
...
},{"./vector":16,"loglevel":3}],12:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
...
},{"./vector":16}],13:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var log = require("loglevel");
var vector_1 = require("./vector");
...
var Streamlines = /** @class */ (function () {
    ...
    function Streamlines(integrator, params) {
        ...
        this.majorGrid = new grid_storage_1.default(this.domainController.worldDimensions, this.domainController.origin, params.dsep);
    }
    ...
    Streamlines.prototype.samplePoint = function () {
        ...
        return new vector_1.default(Math.random() * this.domainController.worldDimensions.x, Math.random() * this.domainController.worldDimensions.y)
            .add(this.domainController.origin);
    };
    Streamlines.prototype.delete = function () {
        var streamlines = [];
        for (var i = 0; i < 50; i++) {
    ...
    Streamlines.prototype.streamlineIntegrationStep = function (major, params) {
     ...
     */
    Streamlines.prototype.createStreamline = function (seed, major) {
        // TODO put this elsewhere
        this.setParamsSq();
        // TODO stopping conditions
        var streamlineForward = [seed];
        var streamlineBackward = [];
        var count = 0;
        var pointsEscaped = false; // True once two integration fronts have moved dlookahead away
        var previousForwardDirection = this.integrator.integrate(seed, major);
        var previousBackwardDirection = previousForwardDirection.clone().negate();
        var previousForwardPoint = seed.clone().add(previousForwardDirection);
        var previousBackwardPoint = seed.clone().add(previousBackwardDirection);
        var validForwards = true;
        var validBackwards = true;
        while (count < this.params.pathIterations && (validForwards || validBackwards)) {
            if (validForwards) {
                streamlineForward.push(previousForwardPoint);
                var nextForwardDirection = this.integrator.integrate(previousForwardPoint, major);
                // Make sure we travel in the same direction
            ...
            if (validBackwards) {
                ...
                var nextBackwardDirection = this.integrator.integrate(previousBackwardPoint, major);
            ...
            // Join up circles
            var sqDistanceBetweenPoints = previousForwardPoint.distanceToSquared(previousBackwardPoint);
...
},{"./domain_controller":9,"./grid_storage":11,"./vector":16,"loglevel":3}],14:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var vector_1 = require("./vector");
...
},{"./vector":16}],15:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var tensor_1 = require("./tensor");
...
},{"./basis_field":6,"./tensor":14}],16:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var log = require("loglevel");
var Vector = /** @class */ (function () {
