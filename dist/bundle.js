...
var Main = /** @class */ (function () {
    function Main() {
        ...
        this.tensorField = new tensor_field_gui_1.default(this.tensorFolder, this.dragController);
        var tensorFieldResetObj = { reset: function () { return _this.tensorField.reset(); } };
        ...
        this.integrator = new integrator_1.RK4Integrator(this.tensorField, this.minorParams);
        this.minorRoads = new streamlines_1.default(this.integrator, this.domainController.origin, this.domainController.worldDimensions, this.minorParams);
        this.majorRoads = new streamlines_1.default(this.integrator, this.domainController.origin, this.domainController.worldDimensions, this.majorParams);
        this.roadsFolder = this.gui.addFolder('Roads');
        this.roadsFolder.open();
        var majorGUI = {
            Generate: this.generateMajorRoads.bind(this),
            JoinDangling: function () { return _this.majorRoads.joinDanglingStreamlines(); },
        };
        var majorRoadsFolder = this.roadsFolder.addFolder('Major');
        majorRoadsFolder.open();
        majorRoadsFolder.add(majorGUI, 'Generate');
        majorRoadsFolder.add(majorGUI, 'JoinDangling');
        var majorRoadsParams = majorRoadsFolder.addFolder('Params');
        this.addParamsToFolder(this.majorParams, majorRoadsParams);
        var majorDevParams = majorRoadsParams.addFolder('Dev');
        this.addDevParamsToFolder(this.majorParams, majorDevParams);
        var minorGUI = {
            Generate: this.generateMinorRoads.bind(this),
            JoinDangling: function () { return _this.minorRoads.joinDanglingStreamlines(); },
        };
        var minorRoadsFolder = this.roadsFolder.addFolder('Minor');
        minorRoadsFolder.open();
        minorRoadsFolder.add(minorGUI, 'Generate');
        minorRoadsFolder.add(minorGUI, 'JoinDangling');
        var minorRoadsParams = minorRoadsFolder.addFolder('Params');
        this.addParamsToFolder(this.minorParams, minorRoadsParams);
        var minorDevParams = minorRoadsParams.addFolder('Dev');
    ...
    Main.prototype.setPathIterations = function () {
    ...
    Main.prototype.generateMajorRoads = function () {
        this.majorRoads = new streamlines_1.default(this.integrator, this.domainController.origin, this.domainController.worldDimensions, Object.assign({}, this.majorParams));
        this.minorRoads.clearStreamlines();
        this.majorRoads.createAllStreamlines();
        this.tensorFolder.close();
    };
    Main.prototype.generateMinorRoads = function () {
        this.minorRoads = new streamlines_1.default(this.integrator, this.domainController.origin, this.domainController.worldDimensions, Object.assign({}, this.minorParams));
        this.minorRoads.addExistingStreamlines(this.majorRoads);
        this.minorRoads.createAllStreamlines();
        this.tensorFolder.close();
    };
    Main.prototype.addParamsToFolder = function (params, folder) {
        // Density
        folder.add(params, 'dsep');
        folder.add(params, 'dtest');
    };
    Main.prototype.addDevParamsToFolder = function (params, folder) {
     ...
     */
    Main.prototype.randomLocation = function () {
    ...
    Main.prototype.addRadial = function () {
        var width = this.domainController.worldDimensions.x;
        this.tensorField.addRadial(this.randomLocation(), util_1.default.randomRange(width / 10, width / 5), // Size
        util_1.default.randomRange(50)); // Decay
    };
    Main.prototype.addGrid = function () {
        this.addGridAtLocation(this.randomLocation());
    };
    Main.prototype.addGridAtLocation = function (location) {
        var width = this.domainController.worldDimensions.x;
        this.tensorField.addGrid(location, util_1.default.randomRange(width / 4, width), // Size
        util_1.default.randomRange(50), // Decay
     ...
     * 4 Grids, one radial
     */
    Main.prototype.setRecommended = function () {
    ...
    ////////////////////////////////
    Main.prototype.getCrossLocations = function () {
    ...
    Main.prototype.getTensorLine = function (point, tensorV) {
    ...
    Main.prototype.draw = function (canvas) {
        ...
        if (this.drawTensorField()) {
            ...
            tensorPoints.forEach(function (p) {
                var t = _this.tensorField.samplePoint(p);
            ...
            if (this.drawCenter) {
                ...
                this.tensorField.getCentrePoints().forEach(function (v) {
            ...
            if (this.minorRoads.allStreamlinesSimple.length > 0) {
                ...
                this.minorRoads.allStreamlinesSimple.forEach(function (s) {
            ...
            if (this.majorRoads.allStreamlinesSimple.length > 0) {
                ...
                this.majorRoads.allStreamlinesSimple.forEach(function (s) {
                    canvas.drawPolyline(s.map(function (v) { return _this.domainController.worldToScreen(v.clone()); }));
                });
...
},{"./ts/impl/integrator":9,"./ts/impl/streamlines":10,"./ts/ui/canvas_wrapper":13,"./ts/ui/domain_controller":14,"./ts/ui/drag_controller":15,"./ts/ui/tensor_field_gui":16,"./ts/util":17,"./ts/vector":18,"dat.gui":1}],6:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var TensorFieldGUI = /** @class */ (function (_super) {
    ...
    function TensorFieldGUI(guiFolder, dragController) {
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
